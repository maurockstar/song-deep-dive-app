...
const MB_UA = "SongDeepDive/0.7 (https://zealous-pond-0200e1e10.7.azurestaticapps.net)"; // MusicBrainz requires a UA
...
const VERSION = "0.7"; // bump to invalidate the shared cache when the AI prompt changes
